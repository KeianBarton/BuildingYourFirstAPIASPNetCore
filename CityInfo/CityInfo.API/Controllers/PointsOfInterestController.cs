    ...
    public class PointsOfInterestController : Controller
    {
        ...
        public IActionResult GetPointsOfInterest(int cityId)
        {
            try
            {
                ...
                var pointsOfInterestForCityResults = Mapper.Map<IOrderedAsyncEnumerable<PointOfInterestDto>>(pointsOfInterestForCity);
            ...
            [FromBody] PointOfInterestForCreationDto pointOfInterest)
        {
            ...
            // Gives URI to where resource created
            ...
            [FromBody] PointOfInterestForUpdateDto pointOfInterest)
        {
            ...
            // Mapper will override values when mapping (so ideal for update)
